...
export const translations: Record<Language, TranslationData> = {
  en: {
    ...
    contact: {
      ...
      description: "Have a visionary project? I'm currently open for select freelance opportunities and collaborations.",
      btn: 'Launch Project',
  ...
  ru: {
    ...
    contact: {
      ...
      description: "У вас есть визионерский проект? В настоящее время я открыт для избранных фриланс-проектов и коллабораций.",
      btn: 'Начать Проект',
